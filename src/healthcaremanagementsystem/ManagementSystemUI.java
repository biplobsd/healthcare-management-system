...
public class ManagementSystemUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bAddApp.setBackground(new java.awt.Color(0, 204, 0));
        bAddApp.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        bAddApp.setText("Add");
        bAddApp.setAutoscrolls(true);
        ...
        bRemApp.setBackground(new java.awt.Color(255, 0, 0));
        ...
        bAddDoc.setBackground(new java.awt.Color(0, 204, 0));
        ...
        bRemDoc.setBackground(new java.awt.Color(255, 0, 0));
        ...
        bAddEPat.setBackground(new java.awt.Color(0, 204, 0));
        ...
        bRemEPat.setBackground(new java.awt.Color(255, 0, 0));
        ...
        bAddNPat.setBackground(new java.awt.Color(0, 204, 0));
        ...
        bRemNPat.setBackground(new java.awt.Color(255, 0, 0));
